 ...
 * @author saul
 */
public class PStatistic implements GenericStatistic{
     //private double tamanhoDaAmostra;
	
	/*public PStatistic(double constante)
	{
		 tamanhoDaAmostra= constante;		
	}
