 ...
 * @author saul
 */
public class VarUChartLimits implements GenericChartLimits {
	...
	public VarUChartLimits(Integer size)
	{
		this.init(size);
	}
	
	public VarUChartLimits()
	{
        ...
        public double calculateAverageP()
	{
		...
		for(Iterator<ArrayList<DataSetItem>> it = this.data.iterator();it.hasNext();)
		{
			...
			dados_para_media.add(novo_item);*/
                ...
                double result = Math.sqrt((this.calculateAverageP()/vart1));
                return Math.sqrt((this.calculateAverageP()/vart1));
        }
